...
# Tạo DAG cho model gold_vti_conso_plan_actual
gold_vti_conso_plan_actual = DbtDag(
    dag_id='dbt_financial_gold_vti_conso_plan_actual',
    project_config=ProjectConfig(project_path),
    profile_config=profile_config,
    render_config=RenderConfig(
        select=["+gold_vti_conso_plan_actual"]  # Chỉ định model cần chạy
    ),
